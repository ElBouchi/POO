...
namespace POO {
	...
	/// <summary>
	/// Description résumée de Qtarticle
	/// </summary>
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(Qtarticle::typeid));
...
#pragma endregion
	...
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		SqlCommand^ cmdDataBase = gcnew SqlCommand("UPDATE Contient SET Quantité_article = "+quantite+" WHERE reference_article = '"+reference+"' AND reference_commande = '" + referenceC + "'  ", conDataBase);
		conDataBase->Open();
